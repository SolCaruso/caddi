        ...
        <div className="prose prose-lg max-w-none">
          ...
          <div className="space-y-8">
            ...
            <section>
              ...
              <p className="text-gray-700 leading-relaxed mb-4">
                If you have any questions about this Cookie Policy, please contact us at <a href="mailto:info@caddiai.com" className="text-caddi-brown hover:underline">info@caddiai.com</a> or visit our <a href="/contact" className="text-caddi-brown hover:underline">contact page</a>.
              </p>
            </section>
          </div>
        </div>
