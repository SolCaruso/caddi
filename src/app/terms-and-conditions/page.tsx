      ...
      <div className="max-w-4xl mx-auto px-4 pt-16 pb-34 sm:px-6 lg:px-8">
        <div className="prose prose-lg max-w-none">
          ...
          <p className="text-sm text-gray-600 mb-8">
            <strong>Last updated:</strong> January 06, 2025
          </p>
          ...
          <div className="space-y-8">
            ...
            <section>
              ...
              <ul className="list-disc pl-6 space-y-2 text-gray-700">
                <li><strong>Application</strong> means the software program provided by the Company downloaded by You on any electronic device, named Forecaddie Golf App</li>
                ...
                <li><strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to CaDDi AI Inc., 1480 Caton Street Ottawa, On, Canada. K1H 6J4.</li>
            ...
            <section>
              ...
              <h3 className="text-xl font-medium text-gray-900 mb-3">Subscription period</h3>
              <p className="text-gray-700 leading-relaxed mb-4">
              ...
              <h3 className="text-xl font-medium text-gray-900 mb-3">Subscription cancellations</h3>
              <p className="text-gray-700 leading-relaxed mb-4">
              ...
              <h3 className="text-xl font-medium text-gray-900 mb-3">Fee Changes</h3>
              <p className="text-gray-700 leading-relaxed mb-4">
              ...
              <h3 className="text-xl font-medium text-gray-900 mb-3">Refunds</h3>
              <p className="text-gray-700 leading-relaxed mb-4">
              ...
              <h3 className="text-xl font-medium text-gray-900 mb-3">Free Trial</h3>
              <p className="text-gray-700 leading-relaxed mb-4">
            ...
            <section>
              ...
              <h3 className="text-xl font-medium text-gray-900 mb-3">Your Feedback to Us</h3>
              <p className="text-gray-700 leading-relaxed mb-4">
            ...
            <section>
              <h2 className="text-2xl font-semibold text-gray-900 mb-4">United States Federal Government End Use Provisions</h2>
              <p className="text-gray-700 leading-relaxed mb-4">
