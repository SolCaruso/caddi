          ...
          <div className="space-y-8">
            ...
            <section>
              ...
              <ul className="list-disc pl-6 space-y-2 text-gray-700">
                ...
                <li><strong>Application</strong> refers to Forecaddie Golf App, the software program provided by the Company.</li>
            ...
            <section>
              ...
              <h4 className="text-lg font-medium text-gray-900 mb-2">Information Collected while Using the Application</h4>
              <p className="text-gray-700 leading-relaxed mb-4">
            ...
            <section>
              <h2 className="text-2xl font-semibold text-gray-900 mb-4">Transfer of Your Personal Data</h2>
              <p className="text-gray-700 leading-relaxed mb-4">
            ...
            <section>
              <h2 className="text-2xl font-semibold text-gray-900 mb-4">Delete Your Personal Data</h2>
              <p className="text-gray-700 leading-relaxed mb-4">
            ...
            <section>
              <h2 className="text-2xl font-semibold text-gray-900 mb-4">Disclosure of Your Personal Data</h2>
              
              <h3 className="text-xl font-medium text-gray-900 mb-3">Business Transactions</h3>
              <p className="text-gray-700 leading-relaxed mb-4">
                If the Company is involved in a merger, acquisition or asset sale, Your Personal Data may be transferred. We will provide notice before Your Personal Data is transferred and becomes subject to a different Privacy Policy.
              </p>

              <h3 className="text-xl font-medium text-gray-900 mb-3">Law enforcement</h3>
              <p className="text-gray-700 leading-relaxed mb-4">
                Under certain circumstances, the Company may be required to disclose Your Personal Data if required to do so by law or in response to valid requests by public authorities (e.g. a court or a government agency).
              </p>

              <h3 className="text-xl font-medium text-gray-900 mb-3">Other legal requirements</h3>
              <p className="text-gray-700 leading-relaxed mb-4">
            ...
            <section>
              ...
              <p className="text-gray-700 leading-relaxed mb-4">
                If you have any questions about this Privacy Policy, please contact us at <a href="mailto:info@caddiai.com" className="text-caddi-brown hover:underline">info@caddiai.com</a> or visit our <Link href="/contact" className="text-caddi-brown hover:underline">contact page</Link>.
              </p>
            </section>
          </div>
        </div>
