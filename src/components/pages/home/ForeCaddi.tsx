...
export default function ForeCaddi() {
  return (
    <section className="w-full flex justify-center flex-col pt-12 pb-30 3xl:pt-34 3xl:pb-64">
      <Container>
        ...
        <div className="w-full rounded-2xl bg-caddi-light pt-6 pb-16 xs:pt-12 xs:pb-20 sm:pt-18 sm:pb-2 sm:px-8 lg:px-12 flex flex-col items-center mx-auto relative">
